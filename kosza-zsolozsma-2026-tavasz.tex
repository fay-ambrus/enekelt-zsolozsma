...
\versicle{Mondjunk áldást \underline{a}z \underline{Ú}rnak!}
  {Istennek legy\underline{e}n h\underline{á}la!}
...
\commentary{Imaóra befejezése, mint az Olvasmányos imaórában.}
...
\subsubsection*{Napközi imaóra - délben}

\begin{psalmsheet}[tone=tonus-irregularis, continuous, number={118. zsoltár 81-88}, numeral={XI. (Kaf)}]
  \psalmtext{
    81. Kimerült a lelkem, míg várom segítségedet, * de nagyon reménykedem igéidben. \\
    82. Kifáradt a szemem, míg ígéretedre várok, * azt kérdem: „Mikor vigasztalsz meg?” ---

    83. Kiszáradtam, mint borostömlő a füstön, * de rendelkezé\-seidet nem felejtem. \\
    84. Ki tudja, hány napja van még szolgádnak? * Mikor ítélkezel már üldözőimen? ---

    85. Kiásták a vermet számomra a gőgösök, * akik nem élnek törvényeid szerint. \\
    86. Kipróbált hűség minden parancsolatod; * álnokul üldöznek, segíts meg engem. ---

    87. Kis híja, hogy el nem törölnek a föld színéről, * de én nem hagyom el parancsaidat. \\
    88. Kegyelmed szerint éltess engem, * ajkad bizonyságait megőrzöm.
}
\end{psalmsheet}

\begin{psalmsheet}[tone=tonus-irregularis, continuous, number={60. zsoltár}, title={Sorsüldözött ember imádsága}, motto={Az örökkévaló javakat remélő igaz ember imája (Szt. Hiláriusz).}]
  \psalmtext{
    2. Hallgasd meg, Istenem, panaszos szavamat, * figyelj imádságomra! \\
    3. A föld széléről kiáltok hozzád, † miközben szorong a szívem; * hozzáférhetetlen kősziklára állíts engem. ---

    4. Te vagy az én reménységem, * és erős bástyám az ellenség ellen. \\
    5. Hadd lakjam hajlékodban mindörökre, * hadd leljek oltalmat védőszárnyaid alatt, \\
    6. mert te, Istenem, meghallgatod imádságomat, * és a neved tisztelőinek szánt örökséget megadod nekem. ---

    7. Adj napokat a király napjaihoz, * és sok nemzedékkel mérjed éveit, \\
    8. ülhessen trónján Isten színe előtt mindörökre, * tartsa meg őt szereteted és hűséged! ---

    9. Akkor mindörökké dicsőítem nevedet, * és amit fogadtam, napról napra teljesítem.
}
\end{psalmsheet}

\begin{psalmsheet}[tone=tonus-irregularis, continuous, number={63. zsoltár}, title={Oltalomkeresés a támadókkal szemben}, motto={Leginkább az Úr szenvedéséről van szó ebben a zsoltárban (Szt. Ágoston).}]
  \psalmtext{
...
\parttitle[Iz 44,21-22]{Rövid olvasmány}

Gondolj arra, hogy szolgám vagy, Izrael! Én alkottalak, a szolgám v\underline{a}gy. † Nem %
feledkezem el rólad. Elsöpröm gonoszságaidat, mint a felhőt, és vétkeidet, m\underline{i}nt a %
ködöt. * Térj vissza hozzám: megvált\underline{o}tt\underline{a}lak!

\versicle{Fordítsd el bűneimtől arcod\underline{a}t,}{És minden gonoszságomat töröld \underline{e}l!}

\commentary{Könyörgés, mint a Reggeli dicséretben.}
