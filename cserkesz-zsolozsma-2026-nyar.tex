...
\markboth{Előtábor 2. nap}{Befejező imaóra az I. Esti dicséret után}\subsection*{Évközi 14. vasárnap - Előtábor 2. nap}
...
\markboth{Előtábor 3. nap}{Imádságra hívás}\subsection*{Hétfő, 14. hét - Előtábor 3. nap}
...
\markboth{Előtábor 4. nap}{Imádságra hívás}\subsection*{Kedd, 14. hét - Előtábor 4. nap}
...
\markboth{Előtábor 5. nap}{Imádságra hívás}\subsection*{Szerda, 14. hét - Előtábor 5. nap}
...
\markboth{Tábor 1. nap}{Imádságra hívás}\subsection*{Csütörtök, 14. hét - 1. nap}
...
\markboth{Tábor 2. nap}{Imádságra hívás}\subsection*{Péntek, 14. hét - 2. nap}
...
\markboth{Tábor 3. nap}{Imádságra hívás}\subsection*{Szent Benedek apát, Európa fővédőszentje - 3. nap}
...
\markboth{Tábor 4. nap}{Olvasmányos imaóra}\subsection*{Évközi 15. vasárnap - 4. nap}
...
\markboth{Tábor 5. nap}{Olvasmányos imaóra}\subsection*{Hétfő, 15. hét - 5. nap}
...
\printsheet{SplendorPaternaeGloriae}
...
\begin{psalmsheet}[tone=8, continuous, number={83. zsoltár}, title={Vágyódás az Úr temploma után}, motto={Nincsen itt maradandó hazánk, hanem jövendő hazánkat keressük (Zsid 13, 14).}]
  \psalmtext{
        2. Mily kedves a te hajlékod, Seregek Ura! * Epedve sóvárog lelkem az Úr udvarába.\\
        3. Lelkem és testem ujjongva eped * az élő Isten után.\\
        4. Még a veréb is otthont talál magának, † és fészket a gerle, ahová fiait helyezze; * a te oltárodnál, Seregek Ura, Istenem és Királyom!\\
        5. Boldogok, akik házadban laknak, * és téged örökké magasztalnak.\\
        6. Boldog ember, akinek te vagy erőssége, * és zarándokútra indítja szíve. ---

        7. Amikor átvonulnak a tikkadt völgyön, forrás fakad ott, * mert áldással halmozza el a korai eső.\\
        8. Újult erővel haladnak az úton, * és megjelennek Istennél a Sionon. ---

        9. Seregek Ura, Istene, hallgasd meg imámat, * fogadd füledbe, Jákob Istene!\\
        10. Oltalmazó Istenünk, nézz le ránk, * tekints kegyesen a te fölkentedre! ---

        11. Bizony, egy nap a te házadban * ezernyi másnál többet ér.\\
        11. Inkább szeretnék az Úr házának küszöbén állni, * mint lakni a gonoszok sátraiban. ---

        12. Mert az Úristen nap és védőpajzs, * kegyelmet oszt és dicsőséget.\\
        12. Nem von meg semmi jót azoktól, * akik ártatlanul élnek.\\
        13. Seregek Ura, boldog az az ember, * aki tebenned bízik.
}
\end{psalmsheet}

\redtext{2. antifóna}

\parttitle[Iz 2, 2-5]{Kantikum}

\printsheet{Venite}

\begin{psalmsheet}[tone=2, continuous, title={Az Úr házának hegye a hegyek fölött}, motto={Eljön minden nemzet, és színed elé borul (Jel 15, 4).}]
    \psalmtext{
        2. Ez történik majd a végső időkben: * Szilárdan áll az Úr házának hegye a hegyek fölött.\\
        2. Magasabb lesz a halmoknál, * és hozzá özönlenek mind a nemzetek. ---

        3. Oda zarándokol sok nép, és így beszél: † „Rajta, menjünk fel az Úr hegyére * és Jákob Istenének házába,\\
        3. hadd tanítson minket útjaira, * hogy járni tudjunk ösvényein,\\
        3. mert Sionról jön a tanítás, * és Jeruzsálemből az Úr igéje.” ---

        4. Ő tesz igazságot a nemzetek között, * és mond ítéletet a sok népnek.\\
        4. És ők ekét kovácsolnak kardjaikból, * lándzsáikból pedig szőlőmetsző késeket.\\
        4. Nemzet nemzet ellen kardot nem emel, * és nem készül többé senki háborúra. ---
...
\begin{psalmsheet}[tone=2, continuous, number={95. zsoltár}, title={Az Úr az egész föld királya és bírája}, motto={Új éneket énekeltek a trónon ülő Bárány előtt (vö. Jel 14, 3).}]
    \psalmtext{
        1. Énekeljetek az Úrnak új éneket, * minden föld az Úrnak énekeljen!\\
        2. Énekeljetek az Úrnak, áldjátok nevét, * napról napra hirdessétek üdvösségét!\\
        3. Hirdessétek dicsőségét a nemzetek között, * és csodatetteit minden nép között! ---

        4. Mert nagy az Úr, és minden dicséretre méltó, * félelmetesebb az összes isteneknél.\\
        5. A nemzetek minden istene csak üres semmiség, * az Úr azonban az ég Alkotója!\\
        6. Színe előtt fönség és méltóság, * szentélyében hatalom és dicsőség! ---

        7. Adjatok az Úrnak, népek családjai, † adjatok az Úrnak dicsőséget és tiszteletet, * ismerjétek el az Úr nevének dicsőségét.\\
        8. Áldozatot hozva lépjetek be udvarába, * és szent fényben boruljatok le az Úr előtt!\\
        9. Színe előtt rendüljön meg az egész föld, * mondjátok a nemzeteknek: „Az Úr uralkodik!”\\
        10. Ő tette a földet szilárddá, és az meg nem inog, * ő ítélkezik a népek fölött igazságban. ---

        11. Örvendjen az ég, és ujjongjon a föld, † zúgjon a tenger egész teljessége, * örvendjen a mező és minden, ami rajta van.\\
        12. Ujjongjon az erdő minden fája is † az Úr előtt, mert eljön, * jön, hogy ítélje a földet.\\
        13. Igazságosan ítéli meg a földkerekséget, * és a népeket hűsége szerint.
}
\end{psalmsheet}

\parttitle[Jak 2, 12-13]{Rövid olvasmány}
Úgy beszéljetek, és úgy cselekedjetek, mint akik fölött majd a szabadság törvénye szerint ítélkezn\underline{e}k. † Mert az ítélet irgalmatlanul lesújt arra, ak\underline{i} nem irgalmas. * Ám az irgalom győzelmet arat az ítél\underline{e}t f\underline{ö}lött.
...
\printsheet{BenedictusDeus}

\rubric{Kantikum a \pageref{ben6}. oldalon.}

\parttitle{Fohászok}

\begin{preces}{Isten a világba helyezte az embert, hogy az ő dicsőségére végezze munkáját. Könyörögve kérjük:}{Add, Urunk, hogy dicsőségedet szolgáljuk!}
  Istenünk, világmindenség Teremtője, áldunk téged,

  \reddash mert nekünk adtad a világ javait, és mindeddig megőrizted életünket.

  Tekints ránk, akik mindennapi munkánkat vállaljuk,

  \reddash és alakíts tetszésed szerint, amikor elfogadsz minket munkatársaidnak!

  Tedd mai munkánkat gyümölcsözővé testvéreink javára,

  \reddash hadd építsünk velük és számukra olyan földi közösséget, amelyben te is kedvedet találod!

  Légy velünk és mindazokkal, akikkel találkozunk,

  \reddash ajándékozz meg minket örömöddel és békéddel!
\end{preces}
Mi Atyánk...

\parttitle{Könyörgés}
Irányítsd és szenteld meg, vezesd és kormányozd, Urunk, Istenünk, ég és föld Királya, a mai napon szívünket és testünket, érzékeinket, szavainkat és tetteinket törvényeid és parancsaid teljesítésének útján, hogy segítségeddel épek és szabadok maradjunk most és mindörökre. A mi Urunk.

\rubric{Befejező imaóra, mint az előtábor 3. napján, \pageref{f2/Compl}.}

\markboth{Tábor 6. nap}{Olvasmányos imaóra}\subsection*{Kedd, 15. hét - 6. nap}

\rubric{Imádságra hívás, mint az előtábor 4. napján, \pageref{f3/Inv}.}
...
\begin{psalmsheet}[tone=7, continuous, number={67. zsoltár}, title={Az Úr ünnepélyes bevonulása}, motto={Fölment a magasba, magával vitte a foglyokat, s osztott az embereknek ajándékokat (Ef 4, 8).}, numeral={I.}]
    \psalmtext{
        2. Fölkel az Isten, és szétszóródnak ellenségei, * színe elől gyűlölői szertefutnak.\\
        3. Úgy szórod szét őket, amint a füst szertefoszlik; † miként elolvad a tűztől a viasz, * az Isten színe elől úgy pusztulnak el a gonoszok.\\
        4. De örvendenek és ujjonganak Isten előtt az igazak, * elragadtatással ünnepelnek. ---

        5. Énekeljetek Istennek, zsoltárt zengjetek nevének, † készítsetek utat neki, aki a felhők fölött vonul, * mert „az Úr” az ő neve!\\
        6. Örvendezzetek színe előtt, † „árvák atyja és özvegyek pártfogója” * Isten az ő hajlékában.\\
        7. Isten otthont ad a hontalannak, † a foglyoknak visszaadja szabadságát, * csak a lázadók maradnak a kietlen pusztában. ---

        8. Amikor te, Istenünk, néped élén kivonultál, * és áthaladtál a pusztán, megrendült a föld,\\
        9. az egek megolvadtak Sínai Ura előtt, * Izrael Istene előtt.\\
        10. Bőven hullattál esőt, Istenünk; * örökségedbe, ellankadt népedbe új erőt öntöttél.\\
        11. Otthont talált a te családod, * ahol jóságodban, Istenünk, gondját viseled szegényeidnek.
}
\end{psalmsheet}
...
\begin{psalmsheet}[tone=1, continuous, numeral={II.}]
    \psalmtext{
        12. Az Úr igéje hangzik, * szüzek nagy serege hirdeti a jó hírt:\\
        13. „Futnak a seregek királyai, futnak, * és a háznak szépe osztja szét a zsákmányt.\\
        14. Míg ti szunnyadoztok az aklok között, * a galamb szárnya ezüstösen fénylik, tollai aranylanak.\\
        15. Mialatt a Mindenható királyokat szór szét, * fehér lesz a Zalmon, mint a hó.” ---

        16. Básán hegye az Isten hegye, * Básán hegye kimagaslik a hegyormok közül.\\
        17. Ugyan mit irigykedtek, hegyek csúcsai, † a hegyre, amelyet lakhelyéül az Úr kiválasztott; * mert az Úr örökre ott lakik!\\
        18. Isten harci szekere ezer és tízezer; * az Úr a Sínairól vonul szentélyébe.\\
        19. Magasba szálltál, foglyokat vittél magaddal, † ajándékul embereket kaptál, * hogy a lázadók is Uruknál, Istenüknél lakjanak. ---

        20. Áldott legyen az Úr naponként és mindenkor, * üdvösségünk Istene, ő visel ránk gondot.\\
        21. Istenünk ő, szabadító Istenünk; * az Úr, a mi Urunk, a halálból is kivezet minket.\\
        22. Valóban, az Isten szétzúzza ellenségei fejét, * sok gonosztevő fürtös fejét. ---

        23. Így szól az Úr: „Básánból kihozlak, * a tenger mélyéből is kivezetlek,\\
        24. hogy vérben gázolhasson lábad, * és kutyáid nyelvének része legyen ellenségeidből.”
}
\end{psalmsheet}
...
\begin{psalmsheet}[tone=8, continuous, numeral={III.}]
    \psalmtext{
        25. Látták bevonulásodat, Isten, * Istenem és Királyom bevonulását a szentélybe.\\
        26. Elöl énekesek mentek, † a menet végén hárfások, * középütt a lányok kézidobbal:\\
        27. „Ünnepi közösségben áldjátok az Istent, * az Urat, ti, Izrael ivadékai!”\\
        28. A törzsek élén az ifjú Benjamin halad, † nyomában Júda vezérei seregükkel, * majd Zebulon nagyjai és Naftali fejedelmei. ---

        29. Mutasd meg, Isten, hatalmadat, * erősítsd meg, Isten, amit bennünk műveltél!\\
        30. Jeruzsálemből, templomodból * királyok hozzák ajándékukat neked.\\
        31. A nádlakó vadat fenyítsd meg, † a tulkok gyülekezetét és népek borjait; * boruljanak le ezüst holmijukkal.\\
        32. Szórd szét a népeket, amelyek háborút akarnak. † Jöjjenek Egyiptom nagyjai, * és Etiópia tárja kezét Isten felé! ---

        33. Föld népei, énekeljetek Istennek, zengjetek zsoltárt az Úrnak, † aki áthalad az egek egein, az ősi egeken, * íme, hallatja szavát, hatalmas szózatát. ---

        35. Ismerjétek el Isten hatalmát, † Izrael fölött ragyogó fölségét * és nagy erejét a felhők felett.\\
        36. Csodálatos vagy, Isten, szentélyedben! † Izrael Istene ad népének hatalmat és erőt; * áldott a mi Istenünk!
}
\end{psalmsheet}

\versicle{Hadd halljam az Úristen szózat\underline{á}t!}{Igen, ő békét hirdet népén\underline{e}k.}
...
\begin{psalmsheet}[tone=6, continuous, number={84. zsoltár}, title={Szabadulásunk közel}, motto={Isten megáldotta földjét, midőn Megváltónkat a földre küldte (Origenész).}]
  \psalmtext{
        2. Megkegyelmeztél, Uram, országodnak, * Jákob sorsát jóra fordítottad.\\
        3. Néped gonoszságát megbocsátottad, * betakartad minden bűnét.\\
        4. Megfékezted nagy haragodat, * eloltottad haragod tüzét. ---

        5. Építsd újjá országunkat, szabadító Istenünk, * és fordítsd el tőlünk haragod!\\
        6. Talán örökké akarsz haragudni ránk, * s kiterjeszted haragodat minden nemzedékre?\\
        7. Nem akarsz új életet adni nekünk, * és örömet szerezni népednek?\\
        8. Mutasd meg, Urunk, irgalmadat, * és adj nekünk szabadulást! ---

        9. Hadd halljam az Úristen szózatát! † Igen, ő békét hirdet népének s híveinek, * és azoknak, akik szívből hozzá térnek.\\
        10. Bizony, akik félik őt, közel azokhoz segítsége, * hogy dicsősége lakja országunkat.\\
        11. Egymásra talál majd irgalom és hűség, * csókot vált az igazságosság és a béke.\\
        12. Hűség sarjad a földből, * és az égből igazságosság hinti sugarát. ---

        13. Mindenféle jókat osztogat az Úr, * és földünk megtermi gyümölcsét.\\
        14. Igazság jár az Úr előtt, * és békesség követi őt.
}
\end{psalmsheet}

\redtext{2. antifóna}

\parttitle[Iz 26, 1-4. 7-9. 12]{Kantikum}

\printsheet{DeNocte}

\begin{psalmsheet}[tone=7, continuous, title={Győzelmi ének}, motto={A város falának tizenkét alapköve van (vö. Jel 21, 14).}]
    \psalmtext{
        1. Erős városunk minékünk Sion, * kőfalak és sáncok védelmezik.\\
        2. Tárjatok kaput, hadd vonuljon be az igaz nép, * amely őrzi a hűséget. ---

        3. Szíve állhatatos, és megőrzi a békét, * hiszen tebenned remél.\\
        4. Örökkön-örökké az Úrban bízzatok, * mert az Úr örökké megmaradó Szikla. ---

        7. Egyenes az igazak útja, * az igaz ember ösvényét te egyengeted.\\
        8. Ítéleted idején is benned reménykedtünk, Uram, * neved dicséretére vágyódott a lelkünk.\\
        9. Utánad vágyódik a lelkem éjjelente, * teljes szívből kereslek téged.\\
        10. Majd ha ítéleted végrehajtod a földön, * igazságot tanulnak a föld lakói. ---

        12. Urunk, te adod meg nekünk a békét, * mert a te műved mindaz, ami velünk történt.
}
\end{psalmsheet}
...
\begin{psalmsheet}[tone=tonus-irregularis, continuous, number={66. zsoltár}, title={Magasztalja Istent minden nemzet!}, motto={Tudjátok meg, hogy Isten üdvössége a pogányoknak jut majd osztályrészül (ApCsel 28, 28).}]
    \psalmtext{
        2. Könyörüljön rajtunk, és áldjon meg minket az Isten, * derítse föl ránk arcának fényét,\\
        3. hadd ismerjék meg útját a földön, * és segítségét az összes nemzetek között. ---

        4. Magasztaljanak téged a népek, Istenünk, * magasztaljanak az összes népek!\\
        5. Örvendjenek és ujjongjanak a nemzetek, † mert te igazságosan ítéled a népeket, * és te vezérled a nemzeteket a földön. ---

        6. Magasztaljanak téged a népek, Istenünk, * magasztaljanak az összes népek!\\
        7. Földünk megadta gyümölcsét, * megáldott minket Isten, a mi Istenünk.\\
        8. Áldjon meg minket az Isten, * félve tisztelje őt a föld minden határa.
}
\end{psalmsheet}

\parttitle[1 Jn 4, 14-15]{Rövid olvasmány}
Láttuk, és tanúságot teszünk ról\underline{a}, † hogy az Atya elküldte a Fiút a világ Üdvöz\underline{í}tőjéül. * Aki vallja, hogy Jézus az Isten Fia, abban benne marad az Isten, és ő is az \underline{I}st\underline{e}nben.
...
\begin{preces}{Imádjuk Krisztust, aki vérével új népet szerzett magának, és kérjük:}{Urunk, emlékezzél meg népedről!}
  Királyunk és Üdvözítőnk, hallgasd meg Egyházadat, amely mai napját dicséreteddel kezdi,

  \reddash tanítsd meg, hogy szüntelenül magasztalja Fölségedet!

  Reményünk és Erősségünk, tebenned van bizodalmunk,

  \reddash és nem szégyenülünk meg sohasem.

  Lásd gyöngeségünket, és siess segítségünkre,

  \reddash hiszen nélküled semmire sem megyünk!

  Emlékezzél meg szegény és elhagyatott testvéreinkről,

  \reddash hogy az új nap ne terhükre, hanem vigasztalásukra és örömükre szolgáljon.
\end{preces}
Mi Atyánk...

\parttitle{Könyörgés}
Mindenható Istenünk, tied a teremtett világ minden szépsége és ékessége. Add, hogy a te nevedben örvendező lélekkel kezdjük a mai napot, és az irántad és testvéreink iránti tevékeny szeretet jegyében fejezhessük be. A mi Urunk.

\rubric{Befejező imaóra, mint az előtábor 4. napján, \pageref{f3/Compl}.}

\markboth{Tábor 7. nap}{Olvasmányos imaóra}\subsection*{Szent Bonaventura püspök és egyháztanító - 7. nap}
...
\rubric{Imádságra hívás, mint az előtábor 5. napján, \pageref{f4/Inv}.}
...
\printsheet{DeusQuiGlorificatur}

\begin{psalmsheet}[tone=8, continuous, number={88. zsoltár, 2-38}, title={Isten nagy irgalma Dávid családja iránt}, motto={Isten, ígéretéhez híven, Dávid családjából támasztotta Jézust, az Üdvözítőt (ApCsel 13, 22-23).}, numeral={I.}]
    \psalmtext{
        2. Az Úr nagy jóságát énekelem szüntelen, * nemzedékről nemzedékre hirdetem hűségét.\\
        3. Így szóltam ugyanis: † „Örökké tart a te irgalmad, * hűségedet szilárddá tetted a mennyben.” ---

        4. „Választottammal szövetséget kötöttem, * megesküdtem szolgámnak, Dávidnak:\\
        5. Örökre megerősítem ivadékodat, * és nemzedékről nemzedékre építem trónodat.” ---

        6. Magasztalják csodás tetteidet az egek, Uram, * a szentek közösségében pedig hűségedet.\\
        7. A fellegekben vane az Úrhoz hasonló, * az Isten fiai közül ki mérhető az Úrhoz?\\
        8. Szentjeinek gyülekezetében félelmetes az Isten, * félelmetesebb és nagyobb, mint akik körülveszik. ---

        9. Uram, mindenható Isten, ki hasonló hozzád? * Hatalmas vagy, Uram, és körülvesz a hűség.\\
        10. Te uralkodol a háborgó tengeren, * te csendesíted le vad hullámait.\\
        11. Megfékezted, mint a megsebzett Ráhábot, * erős karoddal szétszórtad ellenségeidet. ---

        12. Tied az ég, és tied a föld, * te alapoztad meg a földkerekséget és annak teljességét.\\
        13. Észak és Dél a te alkotásod, * nevednek ujjong a Tábor és a Hermon.\\
        14. Hatalmas a te karod, * kezed erős, jobbod dicsőséges.\\
        15. Trónod alapja a jog és az igazság, * színed előtt jár az irgalom és a hűség. ---

        16. Boldog a nép, amely tud ünnepelni, * és arcod fényében járhat, Uram.\\
        17. Egész nap nevednek örvendeznek, * és igazságod felmagasztalja őket.\\
        18. Te vagy minden erősségünk dísze, * és jóvoltodból felemelkedik fejünk.\\
        19. Mert az Úrtól van a mi pajzsunk, * és Izrael Szentjétől a királyunk!
}
\end{psalmsheet}
...
\begin{psalmsheet}[tone=8, continuous, numeral={II.}]
    \psalmtext{
        20. Egykor látomásban így szóltál szentjeidhez: † „Segítségemet egy hősnek adtam, * választottamat a népből fölemeltem.\\
        21. Szolgámra, Dávidra rátaláltam, * és szent olajommal fölkentem őt.\\
        22. Erős támasza kezem lesz, * karom teszi őt erőssé! ---

        23. Ellensége semmire sem megy vele, * és a gonoszság fia el nem nyomhatja őt.\\
        24. Megsemmisítem támadóit szeme előtt, * és megverem gyűlölőit.\\
        25. Hűségem és szeretetem kíséri őt, * és nevemben feje magasra emelkedik.\\
        26. Kezét ráteszem a tengerre, * és jobbját a folyamokra. ---

        27. És ő engem így szólít: Atyám vagy, * Istenem és szabadító Kősziklám!\\
        28. Én pedig elsőszülöttemmé teszem őt: * fölségessé a földi királyok között.\\
        29. Szeretetem iránta örökké megmarad, * és állandó lesz vele szövetségem.\\
        30. Örök időkre fenntartom ivadékát, * és trónusa örökké áll, mint az ég!”
}
\end{psalmsheet}
...
\begin{psalmsheet}[tone=8, continuous, numeral={III.}]
    \psalmtext{
        31. „De ha fiai elhagyják törvényemet, * és nem járnak tanításom útján,\\
        32. ha megszegik rendelkezéseimet, * és nem tartják meg parancsaimat:\\
        33. vétkükre vesszőm lesz a válasz, * gonoszságukra pedig verés! ---

        34. Szeretetemet azonban nem vonom meg tőle, * és hűségemet meg nem változtatom.\\
        35. Nem bontom fel szövetségemet, * és amit ajkam mondott, vissza nem vonom.\\
        36. Megesküdtem egyszer szentségemre, * és Dávidnak hazudni nem fogok:\\
        37. Ivadéka fennmarad örökké, * trónja szilárd színem előtt, mint a nap,\\
        38. és áll örökké, miként a hold, * hűséges tanúm az égen!”
}
\end{psalmsheet}

\versicle{Ragyogva világít szavad fény\underline{e},}{Értelmessé teszi a kicsinyek\underline{e}t.}
...
\begin{psalmsheet}[tone=2, continuous, number={85. zsoltár}, title={Bajba jutott szegény ember imája}, motto={Áldott legyen az Isten, aki megvigasztal minket minden szomorúságunkban (2 Kor 1, 3. 4).}]
  \psalmtext{
        1. Fordulj hozzám, és hallgass meg, Uram, * mert gyámoltalan és szegény vagyok.\\
        2. Végy oltalmadba, mert neked élek; * szabadítsd meg, Istenem, szolgádat, aki benned bízik. ---
        ...
        11. Mutasd meg nekem utadat, Uram, * hogy igazságod szerint járjak.\\
        12. Tedd egyszerűvé szívemet, * hogy félje nevedet.\\
        12. Magasztallak, Uram, Istenem, teljes szívemből, * és nevedet dicsőítem mindörökké,\\
        13. mert annyira szeretsz engem, * hogy a sír mélyéből is kimentesz. ---
...
\parttitle[Iz 33, 13-16]{Kantikum}

\printsheet{BeatiQuiAmbulant}

\begin{psalmsheet}[tone=8, continuous, title={Isten igazságosan ítél}, motto={Az ígéret nektek és fiaitoknak szól, meg azoknak, akik távol vannak (ApCsel 2, 39).}]
    \psalmtext{
        13. Halljátok meg, távol élők, mit tettem én, * ismerjétek meg, közel lakók, az én hatalmamat!\\
        14. Megremegnek Sionban a bűnösök, * rettegés szállja meg a gonoszokat:\\
        14. „Közülünk ki lakhat együtt az emésztő tűzzel? * Közülünk ki lakhat együtt az örök izzással?” ---

        15. Aki igazságban jár, * és igazat beszél,\\
        15. aki megveti a zsarolással szerzett nyereséget, * és elhárítja kezével a megvesztegetést,\\
        15. aki befogja fülét, hogy ne halljon vérontásról, * és behunyja szemét, hogy ne lásson gonoszt: ---

        16. Magasságban fog az lakni, * kősziklák csúcsán talál menedéket.\\
        16. Mindig lesz neki kenyere, * és vize el nem apad.
}
\end{psalmsheet}

\redtext{3. antifóna}

\printsheet{QuiaMirabila}

\begin{psalmsheet}[tone=tonus-irregularis, continuous, number={97. zsoltár}, title={Az Úr diadalmas bíró}, motto={Ez a zsoltár az Úr első eljöveteléről és a népek várakozásáról szól (Szt. Atanáz).}]
    \psalmtext{
        1. Zengjetek új éneket az Úrnak, * mert csodálatra méltó, amit művelt. ---

        1. Diadalt aratott jobbjával, * szentséges karjának erejével.\\
        2. Megmutatta szabadító erejét az Úr, * tudtul adta hűségét a nemzeteknek.\\
        3. Emlékezetbe idézte jóságát és hűségét * Izrael népe iránt.\\
        3. Meglátta a föld minden határa: * Istenünk hozott nekünk szabadulást. ---

        4. Minden földek, zengjetek az Úrnak öröméneket, * ujjongjatok, és énekeljetek!\\
        5. Daloljatok az Úrnak citerával, * citerával és hangos muzsikával.\\
        6. Ércharsonával és zengő kürt szavával * mondjatok éneket az Úr s Király előtt! ---

        7. Zúgjon a tenger és ami betölti, * a földkerekség és ami rajta él.\\
        8. Tapsoljanak a folyamok, † ujjongjanak velük a hegyek az Úr előtt, * mivelhogy jön, és megítéli a földet.\\
        9. Igazságosan ítéli a világot, * hűsége szerint a népeket.
}
\end{psalmsheet}

\parttitle[Jób 1, 21; 2, 10b]{Rövid olvasmány}
Mezítelenül jöttem ki anyám méhéből, és ruhátlanul térek oda vissz\underline{a}. † Az Úr adta, az Úr elvette, amint az Úrnak tetszett, úgy lett; legyen áldott \underline{a}z Úr neve! * Ha a jót elfogadjuk Isten kezéből, miért ne fogadnánk el a r\underline{o}ssz\underline{a}t is?
...
\printsheet{SpirituSapientiae}

\rubric{Kantikum a \pageref{ben2}. oldalon.}

\parttitle{Fohászok}

\begin{preces}{Krisztus Urunk táplálja és oltalmazza Egyházát, amelyért áldozatul adta önmagát. Kérleljük, és mondjuk:}{Tekints, Urunk, Egyházadra!}
  Áldott vagy, Egyházunk pásztora, aki ma világosságot és életet adsz nekünk,

  \reddash engedd, hogy hálaadással fogadjuk drága ajándékaidat!

  Tekints irgalommal nyájadra, amelyet nevedben összegyűjtöttél,

  \reddash hogy senki se vesszék el azok közül, akiket neked adott az Atya!

  Vezesd Egyházadat parancsaid útján,

  \reddash a Szentlélek erejében legyen hűséges hozzád!

  Tápláld Egyházadat igéd és kenyered asztaláról,

  \reddash hogy ennek az ételnek erejében örvendezve kövessen téged!
\end{preces}
Mi Atyánk...

\parttitle{Könyörgés}
Add meg, kérünk, mindenható Istenünk, hogy akik Szent Bonaventura püspök mennyei születésnapját ünnepeljük, kiváló tudásán épüljünk, és lángoló szeretetét folytonosan utánozzuk. A mi Urunk.

\rubric{Befejező imaóra, mint az előtábor 5. napján, \pageref{f4/Compl}.}

\markboth{Tábor 8. nap}{Olvasmányos imaóra}\subsection*{Csütörtök, 15. hét - 8. nap}

\rubric{Imádságra hívás, mint az 1. napon, \pageref{f5/Inv}.}

\markright{Olvasmányos imaóra}\subsubsection*{Olvasmányos imaóra}

\parttitle{Himnusz}

\printsheet{NoxAtraRerum}
...
\printsheet{OmnesInimiciMei}

\begin{psalmsheet}[tone=1, continuous, number={88. zsoltár, 39-53}, title={Gyászének Dávid házának romlása miatt}, motto={Erős Szabadítót támasztott nekünk, szolgájának, Dávidnak családjából (Lk 1, 69).}, numeral={IV.}]
    \psalmtext{
        39. Mégis elvetetted és félredobtad, * fölgerjedt haragod fölkented ellen.\\
        40. Szolgád szövetségét felbontottad, * koronáját a porba aláztad.\\
        41. Falait mind leromboltad, * erődítményeit romhalmazzá tetted.\\
        42. Minden arra járó fosztogatja, * szomszédai előtt csúffá tetted. ---

        43. Elnyomóinak jobbját fölemelted, * ellenségeinek örömet szereztél.\\
        44. Kicsorbítottad kardjának élét, * és nem segítetted őt a harcban.\\
        45. Fényes tündöklésének véget vetettél, * trónját a sárba taszítottad.\\
        46. Megrövidítetted ifjúsága napjait, * és őt szégyenbe öltöztetted.
}
\end{psalmsheet}
...
\begin{psalmsheet}[tone=6, continuous, numeral={V.}]
    \psalmtext{
        47. Meddig rejtőzöl el, Uram, talán végleg? * Meddig lángol haragod tüze?\\
        48. Emlékezz arra, hogy mily rövid az életem, * milyen mulandónak teremtettél minden embert.\\
        49. Ki az az élő ember, aki halált nem lát, * és megmenthetné lelkét az alvilágtól? ---

        50. A régi szereteted, Uram, hol van, * és hűséged, melyet Dávidnak ígértél?\\
        51. Emlékezz, Uram, szolgáid gyalázatára, * amit el kell tűrnöm sok nép részéről,\\
        52. amellyel, Uram, ellenségeid gyaláznak, * gyalázzák fölkented lépteit. ---
...
\printsheet{ConvertereDomine}

\begin{psalmsheet}[tone=1, continuous, number={89. zsoltár}, title={Az Úr jósága ragyogjon fölöttünk}, motto={Egy nap az Úr előtt annyi, mint ezer év, ezer év pedig annyi, mint egy nap (2 Pét 3, 8).}]
    \psalmtext{
        1. Menedékünk te vagy, Urunk, * nemzedékről nemzedékre.\\
        2. Mielőtt a hegyek születtek, † mielőtt a föld és a világ kialakult, * mindöröktől örökre vagy te, Istenünk. ---

        3. Visszaparancsolod az embert a porba; * csak annyit szólsz: „Emberfiak, térjetek vissza!”\\
        4. Mert ezer év a te szemedben annyi, mint a tegnapi nap, amely tovatűnt, * vagy mint egy őrállás ideje éjszaka. ---

        5. Álmot bocsátasz rájuk, * olyanná lesznek, mint a reggel sarjadó virág:\\
        6. hajnalban szirmot bont, kivirul, * estére lehull, és elszárad. ---

        7. Bizony, haragodtól semmivé leszünk, * és indulatodtól elpusztulunk.\\
        8. Szemed előtt állnak gonoszságaink, * titkos bűneinkre arcod fényt derít. ---

        9. Üresen telnek napjaink, mert haragszol, * esztendeink sóhajként szállnak el.\\
        10. Életkorunk mindössze hetven év, * jó erőben lehet tán nyolcvan is.\\
        10. De javarészt még az is baj és törődés; * bizony, hamar elszáll, és mi elmegyünk.\\
        11. Ki tudja fölmérni haragod erejét, * ki fél eléggé haragod hevétől? ---

        12. Taníts meg számot vetni napjaink sorával, * hogy bölcsességre neveljük szívünket.\\
        13. Térj hozzánk, Urunk! Meddig vársz még? * Indítson meg szolgáid könyörgése!\\
        14. Árassz el minket reggel irgalmaddal, * hogy mindennap ujjongjunk és vigadozzunk.\\
        15. Kárpótolj örömmel a sanyarú napokért, * az évekért, amikor rosszul ment sorunk. ---

        16. Lássák meg szolgáid gondviselésedet, * és gyermekeik dicsőségedet.\\
        17. Az Úrnak, Istenünknek jósága ragyogjon fölöttünk, † kezünk munkáját kísérje áldásod felülről, * kezünk munkáját kísérje áldásod.
}
\end{psalmsheet}

\versicle{Uram, tenálad van az élet forrás\underline{a},}{S a te nevedben látjuk az igazi f\underline{é}nyt.}
...
\printsheet{FundamentaEius}

\begin{psalmsheet}[tone=6, continuous, number={86. zsoltár}, title={Jeruzsálem minden népnek anyja}, motto={A szabad asszony a magasságbeli Jeruzsálemet jelenti: ez a mi anyánk (Gal 4, 26).}]
    \psalmtext{
        1. Háza alapjait szent hegyén vetette meg, † mert Sion kapuit szereti az Úr * Jákob bármely hajlékánál jobban. ---

        3. Dicső dolgokat mondanak rólad, * Isten városa!\\
        4. Tisztelőim között említem majd Egyiptomot és Babilont, † Filiszteát, Tiruszt és Etiópiát, * mert ezek mind itt születtek.\\
        5. Sionról pedig azt mondják majd: † „Ez is, meg az is benne született, * és őt maga a Fölséges erősítette meg!” ---

        6. Az Úr bejegyzi a népek könyvébe: * „Ezek mind itt születtek!”\\
        7. És a körtáncot lejtők mind azt dalolják: * „Minden forrásom belőled fakad!”
}
\end{psalmsheet}

\redtext{2. antifóna}

\parttitle[Iz 40, 10-17]{Kantikum}

\printsheet{EcceDominusNoster}

\begin{psalmsheet}[tone=2, continuous, title={A jó Pásztor: a végtelenül fölséges és bölcs Isten}, motto={Hamarosan eljövök, s velem lesz a jutalom (Jel 22, 12).}]
    \psalmtext{
        10. Íme, hatalommal jön az Úr, az Isten, * karja uralkodik.\\
        10. Győzelmének jutalma halad nyomában, * előtte meg a győzelmi jelvények.\\
        11. Mint a pásztor, úgy legelteti a nyáját, † a bárányokat karjába gyűjti, és ölébe fogja, * az anyajuhokat vigyázva tereli. ---

        12. Marokkal ki mérheti meg a tenger vizét, * arasszal ki mérheti föl az eget?\\
        12. Három ujján ki tartja fenn a föld tömegét? * A hegyeket és halmokat ki tudná súlyra mérni mérlegen?\\
        13. Az Úr lelkének ki volt segítője, * ki volt tanácsadója, aki oktatta volna?\\
        14. Kitől kért tanácsot, és ki taníthatta őt, * az igazság ösvényeit ki mutathatta meg neki?\\
        14. A tudományban ki volt mestere, * a bölcsesség útjára ki irányította? ---

        15. A nemzetek olyanok előtte, mint a vízcsepp a vödrön, † annyit érnek, mint porszem a mérlegen, * a szigetek is csak homokszemek!\\
        16. Tűzgyújtásra a Libanon fája nem elég, * és minden állata sem elég égőáldozatnak.\\
        17. Színe előtt minden nemzet olyan, mintha nem is volna, * puszta semmiségnek tartja őket.
}
\end{psalmsheet}

\redtext{3. antifóna}

\printsheet{IustusEtSanctus}

\begin{psalmsheet}[tone=tonus-irregularis, continuous, number={98. zsoltár}, title={Szent az Úr, a mi Istenünk}, motto={Te, aki a kerubok fölött trónolsz, amikor a mi hasonlatosságunkra emberré lettél, megváltoztattad a föld romlott állapotát (Szt. Atanáz).}]
    \psalmtext{
        1. Uralkodik az Úr, reszkessenek a népek! * A kerubok fölött trónol, remegjen a föld!\\
        2. Fölséges az Úr Sionban, * dicsőséges minden nép fölött. ---

        3. Félelmetes nagy nevedet áldják, * mert az valóban Szent!\\
        3. Hatalmas király vagy, szereted az igazságot, † te állapítod meg, mi a helyes, * Jákob népének te szolgáltatsz jogot és igazságot. ---

        5. Magasztaljátok az Urat, Istenünket, † boruljatok lába zsámolyához, * mert ő valóban Szent! ---

        6. Ott van Mózes és Áron is papjai között, * és Sámuel azok között, akik nevét segítségül hívják.\\
        7. Az Úrhoz kiáltottak, és ő meghallgatta őket, * a felhőoszlopból beszélt hozzájuk.\\
        7. Végzéseit megtartották, * és a parancsokat, amelyeket rájuk bízott.\\
        8. Urunk, Istenünk, te meghallgattad őket, † türelmes Istenük voltál, * bár bűneiket megtoroltad. ---

        9. Magasztaljátok az Urat, Istenünket, † és boruljatok le szent hegyén, * mert szent az Úr, a mi Istenünk!
}
\end{psalmsheet}

\parttitle[1 Pét 4, 10-11]{Rövid olvasmány}
Aszerint, hogy ki-ki milyen lelki ajándékot kapott, legyetek egymásnak szolgálatára, hogy az Isten sokféle kegyelmének jó letéteményesei legyet\underline{e}k. † Aki beszél, az Isten szavait k\underline{ö}zvetítse. * Ha valaki szolgál, azzal az erővel szolgáljon, amelyet az Isten ad neki, hogy így minden az Isten dicsőségére váljék Jézus Kriszt\underline{u}s \underline{á}ltal.

\parttitle{Rövid válaszos ének}

\printsheet{ClamaviInTotoCorderMeo}

\parttitle[Lk 1,68-79]{Evangéliumi kantikum}

\printsheet{InSanctitate}

\rubric{Kantikum a \pageref{ben7}. oldalon.}

\parttitle{Fohászok}

\begin{preces}{Adjunk hálát az Atyaistennek, aki szeretetével vezeti és táplálja népét, és kiáltsuk hozzá örvendezve:}{Dicsőség neked, Urunk, örökkön-örökké!}
  Irgalmas Atyánk, magasztalunk szeretetedért,

  \reddash mert csodálatosan megteremtettél, és még csodálatosabban megváltottál bennünket.

  Önts szívünkbe e nap kezdetén igyekezetet, hogy neked szolgáljunk,

  \reddash és gondolatainkkal, tetteinkkel téged magasztaljunk!

  Minden gonosz vágytól tisztítsd meg szívünket,

  \reddash hogy mindig a te akaratodhoz igazodjunk!

  Tedd fogékonnyá szívünket testvéreink és minden ember gondja-baja iránt,

  \reddash ne nélkülözzék a mi testvéri szeretetünket.
\end{preces}
Mi Atyánk...

\parttitle{Könyörgés}
Mindenható, örök Isten, világosítsd meg a halál árnyékában ülő népeket ragyogó dicsőséged fényével, amellyel meglátogat a magasságból Felkelő: Jézus Krisztus, a mi Urunk. Aki veled él.

\rubric{Befejező imaóra, mint az 1. napon, \pageref{f5/Compl}.}

\markboth{Tábor 9. nap}{Olvasmányos imaóra}\subsection*{Péntek, 15. hét - 9. nap}

\rubric{Imádságra hívás, mint az 2. napon, \pageref{f6/Inv}.}

\markright{Olvasmányos imaóra}\subsubsection*{Olvasmányos imaóra}

\parttitle{Himnusz}

\printsheet{TuTrinitasUnitas}
...
\printsheet{ZelusDomusTuae}

\begin{psalmsheet}[tone=1, continuous, number={68. zsoltár 2-22. 30-37}, title={A házadért való buzgóság emészt
}, motto={Epével kevert bort adtak neki inni (Mt 27, 34).}, numeral={I.}]
    \psalmtext{
        2. Ments meg engem, Istenem, * mert a víz már torkomig ér.\\
        3. Feneketlen iszapba süllyedtem, és nincs hol megállnom, * a vizek mélyére kerültem, eltemet a hullám.\\
        4. Belefáradtam a kiáltozásba, torkom berekedt; * míg Istenemre várok, szemem elsötétül.\\
        5. Hajam szálánál is többen vannak, * akik ok nélkül gyűlölnek engem.\\
        5. Nagy erőre kaptak üldözőim, gonosz ellenségeim, * amit el sem vettem, azt kell megfizetnem. ---

        6. Te ismered, Uram, balgaságomat, * bűneim nincsenek rejtve előtted.\\
        7. Akik benned bíznak, ne piruljanak miattam, * Uram, mindenható Isten!\\
        7. Miattam ne érje szégyen azokat, * akik keresnek téged, Izrael Istene! ---

        8. Mert érted viselek gyalázatot, * arcomat érted borítja szégyen.\\
        9. Testvéreim előtt idegenné lettem, * anyám fiai sem ismernek rám. ---

        10. A házadért való buzgóság emészt, * rám hull a gyalázat, ha téged gyaláznak.\\
        11. Sírtam, és böjtöléssel gyötörtem magam, * de az is gyalázatomra vált. ---

        12. Vezeklő szőrruhát öltöttem magamra, * és ezért is szóbeszéd ért.\\
        13. Ellenem beszélnek a kapukban ülők, * a bor mellett is rólam énekelnek.
}
\end{psalmsheet}

\redtext{2. antifóna}

\printsheet{ConsolantemMe}

\begin{psalmsheet}[tone=8, continuous, numeral={II.}]
    \psalmtext{
        14. De én, Uram, tehozzád imádkozom, * kegyelmed idején, Istenem.\\
        14. Hallgass meg mérhetetlen jóságodban, * hűséged szerint segíts meg!\\
        15. Emelj ki az iszapból, hogy el ne süllyedjek, † ragadj ki azok közül, akik gyűlölnek, * és a vizek mélységéből.\\
        16. Ne merítsen el a vizek hulláma, † és ne húzzon le a mélység, * ne záruljon be fölöttem a verem szája. ---

        17. Hallgass meg, Uram, jóságos szeretettel, * nagy irgalmaddal fordulj hozzám.\\
        18. Szolgádtól ne fordítsd el arcodat, * sietve hallgass meg, mert nagyon gyötrődöm! ---

        19. Jöjj közel hozzám, és légy védelmezőm, * ellenségeimtől válts meg!\\
        20. Te ismered gyalázatomat, * csúfos helyzetemet és szégyenemet. ---

        21. Szemed előtt vannak mind, akik gyötörnek engem, * szívemet a szégyen összetörte, ellankadtam.\\
        21. Vártam, hogy valaki együttérez velem, de nem volt, * vigasztalókat kerestem, de nem találtam.\\
        22. Enni nekem epét adtak, * és szomjúságomban ecettel itattak.
}
\end{psalmsheet}

\redtext{3. antifóna}

\printsheet{QuaeriteDominum}

\begin{psalmsheet}[tone=8, continuous, numeral={III.}]
    \psalmtext{
        30. Nyomorult vagyok, és fájdalommal telve, * de segítséged, Uram, fölemel engem.\\
        31. Isten nevét énekszóval áldom, * dicsérettel magasztalom őt.\\
        32. Az Úrnak ez kedvesebb, mint az áldozati bika, * vagy mint az üsző, amelynek szarva és körme van. ---

        33. Látják ezt az alázatosak, és örülnek: * „Ti, akik keresitek Istent, éledjen föl szívetek!”\\
        34. Az Úr meghallgatja a szegényeket, * és foglyait nem hagyja magukra.\\
        35. Dicsérje őt az ég és a föld, * a tengerek és minden, ami azokban mozog. ---

        36. Isten megszabadítja Siont, † Júda városait újra felépíti. * Ott lesz lakóhelyük, és az lesz birtokuk.\\
        37. Azt örökli szolgáinak ivadéka, * és ott laknak majd, akik nevét szeretik.
}
\end{psalmsheet}

\versicle{Az Úr megtanít minket útjair\underline{a}.}{Hogy járni tudjunk ösvénye\underline{i}n.}
...
\begin{psalmsheet}[tone=8, continuous, number={50. zsoltár}, title={Könyörülj rajtam, Istenem!}, motto={Újuljatok meg lélekben és érzületben, s öltsétek magatokra az új embert! (Ef 4, 23-24)}]
    \psalmtext{
        3. Könyörülj rajtam, Istenem, * szerető jóságod szerint,\\
        3. és minthogy mérhetetlen a te irgalmad, * gonoszságomat töröld le rólam!\\
        4. Mosd le bűnömet teljesen, * és vétkemtől tisztíts meg engem! ---
...
\parttitle[Jer 14, 17-21]{Kantikum}

\printsheet{NonNosDerelinquas}

\begin{psalmsheet}[tone=8, continuous, title={A nép siralma éhínség és háború idején}, motto={Közel van az Isten országa: Tartsatok bűnbánatot, és higgyetek az evangéliumban! (Mk 1, 15)}]
    \psalmtext{
        17. Szemem éjjel nappal könnyet ont, * és nem tud csillapodni,\\
        17. mert nagy csapás sújtotta népem szűz leányát, * szerfölött nagy csapás.\\
        18. Kimegyek a mezőkre: † íme, ott karddal leöltek hevernek; * bemegyek a városba: íme, éhségtől aléltakat találok.\\
        18. Próféta is, pap is eltávozott * ismeretlen, idegen országba. ---

        19. Vajon végleg elvetetted Júdát, * vagy tán megutálta lelked Siont?\\
        19. Miért vertél meg minket úgy, * hogy épség rajtunk nem maradt?\\
        19. A békét vártuk, de nem jött semmi jó, * a gyógyulás idejét, és íme, a rettegés van itt. ---

        20. Elismerjük, Urunk, gonoszságainkat † és atyáink bűneit, * bizony, vétkeztünk ellened.\\
        21. Ne adj gyalázatra minket a te nevedért, * és ne hozz szégyent fönséges trónusodra miattunk!\\
        22. Emlékezz meg rólunk, * és ne bontsd fel velünk kötött szövetségedet!
}
\end{psalmsheet}

\redtext{3. antifóna}

\printsheet{ServiteDomino}

\begin{psalmsheet}[tone=tonus-irregularis, continuous, number={99. zsoltár}, title={Az Úr házába lépők örvendezése
}, motto={Isten parancsolja, hogy győzelmi éneket énekeljenek a megváltottak (Szt. Atanáz).}]
    \psalmtext{
        2. Ujjongjatok az Úrnak, minden földek, * szolgáljatok az Úrnak örvendezve;\\
        2. járuljatok színe elé * vidám énekszóval! ---

        3. Tudjátok meg, hogy az Úr az Isten, † ő alkotott minket, övéi vagyunk, * háza népe és legelőjének nyája. ---

        4. Őt magasztalva lépjetek be kapuján, † énekelve vonuljatok hajlékába, * adjatok hálát neki, és áldjátok nevét,\\
        5. mert valóban jó az Úr, † szeretete megmarad örökké, * és hűsége nemzedékről nemzedékre.
}
\end{psalmsheet}

\parttitle[2 Kor 12, 9b-10]{Rövid olvasmány}
A legszívesebben a gyengeségeimmel dicsekszem, hogy Krisztus ereje költözzön bel\underline{é}m. † Kedvem telik a Krisztusért való gyöngeségben, gyalázatban, nélkülözésben, üldöztetésben és szorong\underline{a}ttatásban, * mert amikor gyönge vagyok, akkor vagy\underline{o}k \underline{e}rős.

\parttitle{Rövid válaszos ének}

\printsheet{AuditamFacMihiMane}

\parttitle[Lk 1,68-79]{Evangéliumi kantikum}

\printsheet{VisitavitEtFecit}

\rubric{Kantikum a \pageref{ben5}. oldalon.}

\parttitle{Fohászok}

\begin{preces}{Tekintsünk fel Krisztusra, aki népéért e világra született, meghalt, és feltámadt. Kérjük bizalommal:}{Üdvözítsd, Urunk, azokat, akiket véreddel megváltottál!}
  Áldott vagy, Jézus, emberek Üdvözítője, aki nem haboztál vállalni értünk a szenvedést és a keresztet,

  \reddash és drága véreddel megváltottál bennünket!

  Te örök életre szökellő vizet ígértél nekünk,

  \reddash áraszd ki Szentlelkedet minden emberre!

  Aki elküldted tanítványaidat, hogy hirdessék az evangéliumot minden népnek,

  \reddash segítsd őket, hogy kereszted dicsőségét mindenütt elterjesszék!

  Adj erőt és türelmet a betegeknek és a nélkülözőknek,

  \reddash akiket társul vettél magad mellé a kereszthordozásra!
\end{preces}
Mi Atyánk...

\parttitle{Könyörgés}
Mindenható Atyánk, hatolj be érzéseink világába, hogy parancsaid világosságánál járva, mindig téged kövessünk, mint vezérünket és fejedelmünket. A mi Urunk.

\rubric{Befejező imaóra, mint az 2. napon, \pageref{f6/Compl}.}

\markboth{Tábor 10. nap}{Olvasmányos imaóra}\subsection*{Szent Hedvig királynő - 10. nap}
...
\rubric{Imádságra hívás, mint a 3. napon, \pageref{Com.v./Inv}.}

\markright{Olvasmányos imaóra}\subsubsection*{Olvasmányos imaóra}

\parttitle{Himnusz}

\printsheet{HaeFeminaeLaudabilis}
...
\printsheet{ConfiteanturDomino}

\begin{psalmsheet}[tone=4, continuous, number={106. zsoltár}, title={Hálaadás a szabadulásért}, motto={Isten a tanítást Izrael fiainak adta, amikor békét hirdetett Jézus Krisztus által (ApCsel 10, 36).}, numeral={I.}]
    \psalmtext{
        1. Adjatok hálát az Úrnak, mert jó, * mert örökké szeret minket.\\
        2. Így szóljanak azok, akiket megváltott az Úr, * akiket megmentett az ellenség kezéből,\\
        3 .és akiket minden tájról összegyűjtött, † napkeletről és napnyugatról, * északról és délről. ---

        4. Bolyongtak a pusztában, a sivatagban, * lakott város felé utat nem találtak.\\
        5. Az éhségtől és a szomjúságtól * szinte elepedt a lelkük. ---

        6. Az Úrhoz kiáltottak gyötrelmükben, * aki szorult helyzetükből kiragadta őket.\\
        7. Egyenes úton vezette őket, * hogy lakott városba jussanak.\\
        8. Adjanak hálát az Úrnak jóságáért, * az emberek fiaival tett nagy csodáiért,\\
        9. mert bő vizet adott a szomjazóknak, * és az éhezőket jóllakatta. ---

        10. Sötétben, a halál árnyékában ültek, * nyomorultan, vasra verve,\\
        11. mert ellenszegültek Isten szavának, * a Magasságbeli döntését megvetették.\\
        12. Ezért alázta meg szívüket szenvedéssel, * elestek, és nem volt, aki fölsegítse őket. ---

        13. Az Úrhoz kiáltottak gyötrelmükben, * aki szorult helyzetükből kiragadta őket.\\
        14. Kivezette őket a sötétből, a halál árnyékából, * és bilincseiket összetörte.\\
        15. Adjanak az Úrnak hálát jóságáért, * az emberekkel tett nagy csodáiért,\\
        16. mert az érckapukat összetörte, * és a vaszárakat összezúzta.
}
\end{psalmsheet}

\redtext{2. antifóna}

\printsheet{DeNecessitatibusNostris}

\begin{psalmsheet}[tone=8, continuous, numeral={II.}]
    \psalmtext{
        17. A gonoszság útján balgaságba estek, * és bűneik miatt nyomorba jutottak.\\
        18. Megutáltak minden eledelt, * s már a halál kapujához értek. ---

        19. Az Úrhoz kiáltottak gyötrelmükben, * aki szorult helyzetükből kiragadta őket.\\
        20. Elküldte igéjét, és meggyógyította őket, * életüket kimentette a pusztulásból,\\
        21. hogy az Úrnak hálát adjanak jóságáért, * az emberekkel tett nagy csodáiért,\\
        22. hogy a dicséret áldozatát bemutassák, * és ujjongással hirdessék tetteit. ---

        23. Akik hajóikon mély tengerre szálltak, * és a nagy vizek hátán végezték munkájukat,\\
        24. azok láthatták az Úr nagy tetteit, * és csodáit a mély tengeren.\\
        25. Szavára szélvihar támadt, * és hullámok tornyosultak:\\
        26. Felemelkedtek az égig, † majd lezuhantak a mélységekig, * s nagy veszedelmükben már kétségbeestek.\\
        27. Meginogtak, tántorogtak, mint a részeg, * és odaveszett minden bölcsességük. ---

        28. Az Úrhoz kiáltottak gyötrelmükben, * aki szorult helyzetükből kiragadta őket.\\
        29. Szellővé csendesítette a vihart, * a hullámok elcsitultak.\\
        30. Örültek is a nagy csendességnek; * így vezette őket az óhajtott kikötőbe,\\
        31. hogy az Úrnak hálát adjanak jóságáért, * az emberek fiaival tett nagy csodáiért,\\
        32. és hogy magasztalják őt a nép gyülekezetében, * és a vének tanácsában is dicsőítsék.
}
\end{psalmsheet}

\redtext{3. antifóna}

\printsheet{QuisIntelleget}

\begin{psalmsheet}[tone=1, continuous, numeral={III.}]
    \psalmtext{
        33. A folyókat sivataggá tette, * és a forrásokat szomjas földdé,\\
        34. a termőföldet pedig szikessé, * az ott lakók bűnei miatt.\\
        35. Aztán a pusztát tóvá változtatta, * a kiszáradt földet vizek forrásává. ---

        36. Ott telepítette le az éhezőket, * hogy lakóvárost alapítsanak.\\
        37. Bevetették földjüket, telepítettek szőlőt, * és az bőséges termést hozott nekik.\\
        38. Megáldotta őket, és megsokasodtak, * és jószágaik számát nem engedte fogyni. ---

        39. Majd ismét megfogyatkoztak, nyomorba jutottak, * és gyötrődtek bajtól, szenvedéstől.\\
        40. De aki a fejedelmeket is megvetéssel sújtja, * és úttalan pusztán hagyja bolyongani:\\
        41. az felemelte nyomorából a szegényt, * és nemzetségüket, mint nyájat megsokasította.\\
        42. Látják ezt az igazak, és örvendeznek, * ám bezárul minden gonosz ajka. ---

        43. Ki olyan bölcs, hogy felfogja ezt, * és megértse az Úr szeretetét?
}
\end{psalmsheet}

\versicle{Uram, a fellegekig ér a te hűség\underline{e}d,}{Ítéleteid oly mélyek, mint a teng\underline{e}r.}
...
\printsheet{NobilemChristiFamulam}

Benne a jóság csorduló forrását\\
hitnek, reménynek, szeretetnek hívják,\\
mellyel testvérség köteléke éled,\\
s bővül az élet.\\

Érdeme láttán a mi bűneinket,\\
rossz tetteinket, Jézus ne tekintsed,\\
hogy neked szóljon szívünkből az ének:\\
tárva a lelkünk!\\

Égi Atyánkat illeti a fenség,\\
Egyszülöttét is tisztelet, dicsőség,\\
éltető Lelkük egyenlő hatalmát\\
mindenek áldják! Ámen.\\

\parttitle{Zsoltározás}

\redtext{1. antifóna}

\printsheet{InMatutinisDomineMeditabor}

\begin{psalmsheet}[tone=3, continuous, number={118. zsoltár, 145-152}, title={XIX. (Kof)}]
    \psalmtext{
        145. Teljes szívemből kiáltok, hallgass meg, Uram, * parancsaidat én megtartom.\\
        146. Tehozzád kiáltok, szabadíts meg engem, * intelmeidet én híven őrzöm. ---

        147. Téged szólít kiáltásom már hajnal előtt, * mert nagyon reménykedem igéidben.\\
        148. Téged kutat szemem virradat előtt, * hogy szavaidról elmélkedjem. ---

        149. Tekints jóságodban könyörgésemre, Uram, * ítéleteid szerint éltess engem!\\
        150. Túl közel vannak már álnok üldözőim, * de törvényedtől távol vannak. ---

        151. Te azonban közel vagy, Uram, * minden intelmed maga a hűség.\\
        152. Tudtam én parancsaidról kezdet óta, * és azt is, hogy mindörökre adtad.
}
\end{psalmsheet}

\redtext{2. antifóna}

\parttitle[Bölcs 9, 1-6. 9-11]{Kantikum}

\printsheet{MecumSitDomine}

\begin{psalmsheet}[tone=2, continuous, title={Uram, adj nekem bölcsességet!}, motto={Olyan ékesszólást és bölcsességet adok nektek, hogy egyetlen ellenfeletek sem tud ellenállni (Lk 21, 15).}]
    \psalmtext{
        1. Atyáink Istene, jóságos Urunk, * igéddel hívtad létre a mindenséget. ---

        2. Bölcsességeddel megalkottad az embert, * hogy uralkodjék minden teremtményen, melyet te alkottál,\\
        3. hogy a földkerekséget hűségben és igazságban igazgassa, * és egyenes szívvel hozza meg ítéletét.\\
        4. Add nekem a bölcsességet, trónodon társadat, * és gyermekeid közül ne zárj ki engem,\\
        5. mert szolgád vagyok, szolgálód gyermeke, † gyenge, csak rövid ideig élő ember, * fel sem fogom igazságodat és törvényedet.\\
        6. Ha mégoly tökéletes valaki az emberek fiai között, † de nincs meg benne bölcsességed, * semminek sem számít! ---

        9. Nálad a bölcsesség, aki művedet ismeri, * és jelen volt, amikor a földkerekséget megalkottad.\\
        9. Ő jól tudja, mi kedves a szemedben, * és mi egyezik meg parancsaiddal.\\
        10. Őt küldd el szent egedből, * fölséges trónod helyéről,\\
        10. hogy velem járjon, és velem munkálkodjék, * és megtudjam, mi kedves előtted.\\
        11. Mert ő mindent tud, és megért mindent, † megfontoltan vezet tetteimben, * és megőriz hatalmával.
}
\end{psalmsheet}

\redtext{3. antifóna}

\printsheet{VeritasDomini}

\begin{psalmsheet}[tone=4, continuous, number={116. zsoltár}, title={Az irgalmas Isten dicsérete}, motto={Állítom, … irgalmasságáért magasztalják Istent a pogányok (Róm 15, 8. 9).}]
    \psalmtext{
        1. Dicsérjétek az Urat, minden népek, * magasztaljátok őt, minden nemzetek. ---

        2. Mert erős fölöttünk az ő irgalma, * és az Úr hűsége örökké megmarad!
}
\end{psalmsheet}
...
\printsheet{AdiuvabitEam}

\parttitle[Lk 1,68-79]{Evangéliumi kantikum}

\printsheet{SimileEst}

\rubric{Kantikum a \pageref{ben4}. oldalon.}

\parttitle{Fohászok}

\begin{preces}{Testvéreim, minden szent asszonnyal együtt tegyünk hitet Üdvözítőnk mellett és mondjuk:}{Jöjj el, Urunk, Jézus!}
  Urunk, Jézus, te a bűnös asszonynak sokat megbocsátottál, mert nagyon szeretett,

  \reddash bocsáss meg nekünk is, mert sokat vétkeztünk!

  Urunk, Jézus, utaidon szent asszonyok szolgáltak neked,

  \reddash add, hogy téged követve járjuk életünk útját!

  Urunk, Jézus, amikor tanítottál, Mária hallgatott téged, Márta pedig szolgált neked,

  \reddash engedd, hogy hitben és tevékeny szeretetben mi is téged szolgáljunk!

  Urunk, Jézus, aki testvérednek, nővérednek és anyádnak nevezted mindazokat, akik akaratodat teljesítik,

  \reddash segíts, hogy szavainkkal és tetteinkkel mindig megnyerjük tetszésedet.
\end{preces}
Mi Atyánk...

\parttitle{Könyörgés}
Istenünk, aki híveid élete vagy és az alázatosak dicsősége, te Szent Hedvig királynét a hit és a szeretet buzgó terjesztőjévé tetted. Közbenjárására add, hogy az igazság és a jóság apostolai legyünk. A mi Urunk.
