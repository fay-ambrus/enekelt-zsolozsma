...
\newfontfamily\lyricfont[ItalicFont={Cambria Italic}]{Cambria}
\newfontfamily\psalmfont[BoldFont={Cambria Bold},ItalicFont={Cambria Italic}]{Cambria}
\newfontfamily\headingfont[BoldFont={Cambria Bold},ItalicFont={Cambria Italic}]{Cambria}
\setmainfont[BoldFont={Cambria Bold},ItalicFont={Cambria Italic},BoldItalicFont={Cambria Bold Italic}]{Cambria}
...
% Black title command
\newcommand{\blacktitle}[2][]{
  \vskip\blockvskip
  \par\noindent
  \headingfont\fontsize{10}{12}\selectfont
  \textbf{\MakeUppercase{#2}}%
  \ifx&#1&\else\hfill#1\fi
  \nopagebreak
  \par
}
...
\newcommand{\subsubsubsection}[1]{
  \vskip\blockvskip
  {\par\centering
  \headingfont\fontsize{10}{12}\selectfont\bfseries
  \MakeUppercase{#1}\par}%
  \nopagebreak
}
